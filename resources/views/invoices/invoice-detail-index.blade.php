...
<div class="container">
	<div class="columns">
		<div class="column is-two-fifths">
			<ul class="nav nav-tabs" id="invoice_detail_tablist" role="tablist">
            <li class="nav-item">
               <a class="nav-link active" id="invoice_detail_tab" data-toggle="tab" href="#invoice_detail_content" role="tab"
                  aria-controls="home" aria-selected="true">Invoice Detail</a>
            </li>
			</ul>
			<div class="tab-content" id="invoice_detail_page_content">
            <div class="tab-pane fade show active" id="invoice_detail_content" role="tabpanel"
               aria-labelledby="invoice_detail_tab">
               <div class="columns">
                  <div class="column">
                     <div>
                        @auth
                        <invoice-detail-form :items="items" :stores="stores" :invoices="invoices"></invoice-detail-form>
                        <br>
                        @endauth                      
                        <div class="columns">
